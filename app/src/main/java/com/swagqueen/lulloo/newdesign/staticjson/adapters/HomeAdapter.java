...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.CustomViewHolder> {
    ...
    public HomeAdapter(Context context, List<EmployeeModel> employeeModelList) {
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View mView = LayoutInflater.from(context).inflate(R.layout.grid_home_items, viewGroup, false); //TODO your xml
